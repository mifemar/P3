document.addEventListener("DOMContentLoaded", ()=>{
    ...
    function startVibration() {
        ...
        const moveLogo = ()=>{
            ...
            if (Math.abs(currentPosition) >= amplitude) direction *= -1;
            if (isVibrating) setTimeout(moveLogo, duration);
    ...
    document.getElementById("newsletter-form").addEventListener("submit", (event)=>{
        ...
        alert("\xa1Muchas gracias por suscribirte a nuestra newsletter!");
        document.getElementById("newsletter-form").submit();
    });
});

//# sourceMappingURL=presentacion.09c24910.js.map
